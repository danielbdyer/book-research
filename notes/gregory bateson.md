...
Gregory Bateson was an anthropologist and systems thinker whose work on communication, learning, and pathology anticipated three pieces of the framework at once. The space-around survey calls him "possibly the largest single missing grandfather in the whole edifice" and places him first in its priority list (space-around: around the engine). This evaluation reads the primary texts against the survey's three claimed correspondences; the seating decision is the author's.
...
Two refusals, and the second is aimed at the book's method rather than at its doctrine.

The first is a safety warning attached to exactly the level the book's arc arrives at. Bateson writes that "even the attempt at level III can be dangerous, and some fall by the wayside. These are often labeled by psychiatry as psychotic," and that "to demand this level of performance of some men and some mammals is sometimes pathogenic." He describes the outcome he is naming in terms the book's peak material also uses: "to the degree that a man achieves Learning III, and learns to perceive and act in terms of the contexts of contexts, his 'self' will take on a sort of irrelevance. The concept of 'self' will no longer function as a nodal argument in the punctuation of experience." The book invites every reader toward that transition and treats the descent from it as the sacred half; Bateson, describing the same transition, says some people do not come back.

The second refusal is structural. Bateson held that conscious purpose is the pathology rather than the instrument: "if you allow purpose to organize that which comes under your conscious inspection, what you will get is a bag of tricks" ("Conscious Purpose versus Nature," in *Steps*). A curriculum of twelve deliberately named forms is, in his exact phrase, what he is warning against. He was the last resident scholar at Esalen and was skeptical of what the institution around him was doing, including its psychedelics: what is required, he argued, "is not simply a relaxation of consciousness to let the unconscious material gush out," but "the synthesis of the two views." The book already agrees with the second clause and would have to answer the first.
