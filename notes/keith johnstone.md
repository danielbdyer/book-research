---
description: The theatre teacher whose Impro reached presence under witness through training actors rather than through philosophy, in the discipline the sort finds emptiest and the one the author came from.
...
Presence under witness is the book's basic posture, and Johnstone reached a working version of it by teaching rather than by argument, in a discipline with no contact with either pole of the founding convergence ([[unrelated traditions converge on presence without agenda while remaining available to act]], [[the convergence's independence fails where three of its names share one teacher]]).

Practitioner pedagogy is one of three disciplines the sort finds near-empty across every load, and the grid reads that emptiness as describing the reading rather than the field.

And the grid's third point is personal: "Given the theatre in your own background, this is a homecoming rather than an import" (`mesh grid: tier 3`). The vault holds that the author's facilitation craft is written into the book and that his organizing images came from his own working life; a lineage he already stands in is a different kind of candidate from one being brought to him.

The status material has no equivalent in the book at all. The corpus has a rich account of what happens in a held container and nothing on the continuous, involuntary status transaction that is also happening.
...
Relevant Notes:
- [[unrelated traditions converge on presence without agenda while remaining available to act]] — the posture he reached through training actors
- [[the convergence's independence fails where three of its names share one teacher]] — the test he passes
- [[the field between two people does work]] — the claim his status material would extend into territory the book has not covered
- [[transformation is enacted participation inside a held container]] — the law his account of the offer bears on
- [[donald schon]] — the other name that would populate the same near-empty discipline
- [[the book's native genre is the letter from a friend read alone]] — the form his objection to solitary work presses against
