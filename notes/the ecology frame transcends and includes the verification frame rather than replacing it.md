---
description: "The ecology frame becomes the new ground and transcends and includes the verification frame, keeping its four apophatic tensions as re-nested guardrails rather than replacing, refuting, or deleting them."
category: claim
...
The reframe moves the ground without discarding what stood on it. In the prior frame, the book's verification apparatus is the ground: the felt shift is the single test of truth, the one-chair codex making a two-chair argument is the structural wound, the second chair is the remedy, and the register that recruits an appreciating posture is the standing hazard. The reframe makes the ecology of loci — and the book's meta-facilitation position within it, two steps back from the outcome — the new ground, and it re-nests those four tensions as features and guardrails inside that ground rather than deleting or refuting them. This is transcend-and-include in Wilber's sense: the larger frame preserves the smaller without collapsing it. Each of the four remains live and real; what changes is its standing, from the bedrock the book rested on to a guardrail nested within a wider field. The move applies to itself, so the ecology frame does not become the new sovereign, on the same constraint that forbids any single locus ruling the rest.
...
- The usage is faithful to Wilber's own gloss and can now be sourced rather than asserted (read 2026-09-02). Tenet 5 of *Sex, Ecology, Spirituality*: "Each emergent holon transcends but includes its predecessor(s)… It preserves their being but negates their partiality or exclusiveness. 'To supersede,' said Hegel, 'is at once to preserve and to negate'"; and his gloss, "all the basic structures and functions are preserved and taken up in a larger identity, but all the exclusivity structures and functions that existed because of isolation, set-apartness, partialness, exclusiveness, separative agency — these are simply dropped" (SES, Book One, ch. 2). The vault's move performs both halves: the four tensions are preserved in their being and negated in their sovereignty. One caveat: in Excerpt A Wilber says "'transcend and include' refers primarily to tetra-inclusion," where what is included is inherited outside conscious awareness (p. 172); a deliberate re-grounding of a book's frame is a conscious act, so the vault's use is analogical at that joint. The phrase is Wilber's own; Koestler coined *holon*, not the verb ([[ken wilber]]).
