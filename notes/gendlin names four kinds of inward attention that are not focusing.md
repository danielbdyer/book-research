...
**Self-engineering.** Talking at oneself, "arranging and rearranging one's feelings without stopping to sense quite what they are." The footnote then makes a claim the vault did not expect to find here: willpower is real and often necessary, but "they cannot be effectively exerted at points where experiencing does not implicitly function." Will works exactly where the process is already carrying forward, and fails where it is not.
