...
The reader gains the recognition that the knowing they are reaching is not a new intellectual acquisition but the articulation of a competence the body already had — the way a walker knows a path before they could draw the map. The knowing beneath the words is practical and bodily, an "I can," not a proposition; so when the book's sentence lands, it is naming a way the reader's body already moves, not installing a belief they must now defend. What the reader gains is the deep ease of catching up to themselves — the words arrive as description of a path already walked, so understanding feels like homecoming rather than construction. Its use to the writing is to root the walkable-house architecture in motor intentionality: a walk, not a lecture, is the honest form, because the knowing is a bodily way before it is a stated idea.
...
Relevant Notes:
- [[the house with no ceiling is transcendence with plumbing]] — the walkable house this roots in the body, a walk because the knowing is a bodily way
- [[psychedelic names a movement not a substance]] — the movement the book asks the reader to walk, a bodily "I can" before a stated idea
- [[maurice merleau-ponty]] — the lived body that understands before reflection, seated in the company
- [[reading is remembering]] — the homecoming this describes, the words naming a path already walked
