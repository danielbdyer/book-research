...
- The two colophons that list the corpus's compilation threads (atlas, colophon; walked, colophon) name the Arc and the Gloss treatment and the seventeen trial chapters, and name no abridged edition. Whether this edition is one state of the trial chapters or a separate artifact is not determinable from the documents in `sources/`.
