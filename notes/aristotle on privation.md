...
recommendation: "Seat as reference-lineage with the precedent load, and inherit the objection with the credential. The corpus's own instruction is one sentence of lineage; the objection it brings — privation under-describes suffering that is a presence rather than an absence — is worth more than the sentence, because the book already houses its bearers and has never connected them to it."
sources: ["space-around: around the chemistry", "atlas §IV", "abridged ch6"]
works: ["Physics I.7–9 (form, matter, privation)", "Metaphysics V.22 (the senses of steresis)", "Augustine, Confessions VII and Enchiridion; Aquinas, Summa Theologiae I q.48 (the privatio boni sequel)"]
topics: ["[[interlocutors]]", "[[contraction-not-corruption]]"]
---

# aristotle on privation

In *Physics* I, Aristotle argues that change requires three principles rather than two: a substratum that persists, a form it comes to have, and *steresis* — the privation, the determinate absence of that form in the thing beforehand. The unmusical man becomes musical; what makes this a change rather than a substitution is that the same man was, precisely, *un*-musical. Privation is not mere nothing. It is a specific absence, indexed to what is missing, in a thing capable of having it. The medieval sequel took the same structure into the problem of evil: *privatio boni*, evil as the absence of a good that ought to be present rather than a substance of its own.

That is the book's Privation Principle, arrived at twenty-four centuries earlier and about a wider subject. The corpus states both the debt and the omission: "The Privation Principle has an ancient patent-holder we've never cited: Aristotle… The book's signature move is a two-thousand-four-hundred-year-old move, made new by being run through the body" (space-around: around the chemistry). The last clause is the honest statement of what remains the book's own — not the analysis, but its verification in the body and its use as an instruction rather than an ontology.
