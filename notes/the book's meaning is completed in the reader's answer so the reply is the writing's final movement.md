...
The reader who finishes this book has not received a finished thing — they have been handed the last unwritten line and asked to write it. What they gain is a standing they rarely get from a book: their response is not applause for a completed object but the closing gesture of the object itself, so the meaning they make in answering is not "their interpretation" set beside the real one but the real one arriving. The book is built to be incomplete without them, and that incompleteness is a gift, because it is the only shape in which a reader can be a maker rather than a recipient. Its use to the writing is a humbler, truer account of what a book can do: the book is not the thing that recognizes, the reader is, and the book is only the address that occasions it.
...
Relevant Notes:
- [[the reader becomes author of what happens in their encounter with the text, not co-author of the text]] — the exact bound this keeps, the reader authoring the encounter rather than the sent text
- [[the fusion of horizons is the strata's strongest account of meaning as an event owned by neither reader nor text]] — the Gadamer arrival already in the vault, the meaning event this completes in the reader
- [[iser distinguishes completion from participation as two fates of the textual gap]] — the Iser mechanism this anchor draws on, realization completing the text
