---
description: "One paragraph of the abridged edition calls the six base primitives elementary operations that constitute almost everything a person does, and the next says they are useful not as facts but as tools."
category: tension
status: treated
treatment: "the author's decision of 2026-08-04, which demotes the schemes from architecture to instrument on the Vijnana Bhairava's model — the draft's weaker sentence is the one now standing"
sources: ["abridged ch5", "abridged: prologue", "atlas §II", "atlas §III"]
...
The wobble is not confined to that page. The same edition's prologue takes the weak side as far as it goes — the triad, primitives, and molecules "are scaffolding. They are the wooden forms a craftsman uses to coax a curve into existence and then removes when the curve holds" (abridged: prologue) — while the atlas takes the strong side as far as it goes, filing the triad as "found, not invented" and treating its portability as evidence for an axiom (atlas §II). A single draft holding both is what makes this a tension in the book's doctrine rather than a difference between two states of one element.
