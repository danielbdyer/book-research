---
description: The corpus flags that the book is built almost entirely from Express, one of its own twelve primitives, and it declines to answer what the book would have been if built on another one.
category: tension
status: live
...
topics: ["[[tensions]]", "[[open-questions]]"]
---
...
The tension does real work in two directions. It qualifies the book's authority — a framework of twelve operations, delivered entirely through one of them, has a composition bias its own theory can name. And it connects to the release question: a volume built from Express is, in the atlas's formulation, "Express, awaiting consent" (atlas §VI) — the same condition described at [[seventeen chapters rest at madhyama]].
