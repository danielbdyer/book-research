...
The empirical history is the remaining gap, and it is the one the corpus's own story leans on. The 1964 paper is theory; its one research citation calls the physiological evidence "tentative" in Gendlin's own word (fn. 10). What predicted change in the recorded therapy studies is in the 1968 focusing-ability paper and the later reviews, none read here, and the 1969 research paper is paywalled. *Focusing* itself remains unread as a book, though the gap is narrower than it was: the parallel round verified its protocol passages verbatim (the fourth and fifth movements and the checking-in section), while the life-sentence the corpus quotes is still unverified against its page. *A Process Model* remains unread and was inaccessible to the parallel round as well — and the chair's question about where the philosophical weight sits now points at it with more urgency, since the 1964 paper carries more of it than expected.
