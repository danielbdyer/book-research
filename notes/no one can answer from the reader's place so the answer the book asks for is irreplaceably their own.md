...
This is the via-positiva turn of Bakhtin's hardest sentence: "there is no alibi in being" sounds like a sentence of inescapable responsibility, but its affirmative face is that the reader is non-substitutable — the one thing no other person and no author can do is answer from the exact place the reader occupies. What the reader gains is irreplaceability: the book is addressed not to interchangeable "readers" but to the single unrepeatable position they alone hold, and the answer it wants is one that only they can give, which means their reply is a genuine addition to the world that would not exist without them. To be told "only you can answer this, from where you are" is to be given back the weight of one's own particular life. Its use to the writing is to sharpen "you already know everything in this book" from a generic knower into the single one who alone can remember it.
...
Relevant Notes:
- [[reading is remembering]] — the front-matter promise this sharpens from a generic knower to the single one who can remember it
- [[the book is written to the relational field and enacted upon the author first]] — the singular address this shares, the book written to a specific place rather than a crowd
- [[being summoned by another's need makes you irreplaceable rather than dissolving you into them]] — the relational-field twin, irreplaceability as dignity arriving from the summons
