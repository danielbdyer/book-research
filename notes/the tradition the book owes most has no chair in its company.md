...
The corpus places the Kashmir Śaiva tradition beneath the company of thinkers rather than in it, and the author has now put a question to that arrangement in his own words: "to stage it as a compatriot to aletheia and yet to not give it its flowers in the rooms… to subdue it as most importantly but 'only' the watershed — gives me pause" (author statement, 2026-08-03). The same statement loosens the ground the arrangement stands on: the grouping of the company into rooms "is not set in stone but was a trapping of a prior draft of the book."
...
A chair can also do one thing a watershed cannot: refuse. The book keeps each seated thinker's refusal so the thinker survives being cited, and a landscape cannot argue back. The corpus records no refusal from this tradition anywhere; at the author's request, four candidate refusals have now been derived from the tradition's own texts and await his testing at [[the kashmir shaiva tradition would decline four of the book's deepest moves]]. The scholarship supports the chair on this exact point: Isabelle Ratié's study of the Pratyabhijñā establishes that the system was built in live argument with Buddhist and Brahmanical opponents, concept by concept, rather than expounded from scripture ([[isabelle ratie]]). A tradition that earned its positions polemically can argue back, which is the capacity a chair holds and a watershed does not.
