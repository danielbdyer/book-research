...
- [[the collection moves from poems with no addressee to a request that can be refused]] — the same passage from unspoken to answerable, traced across a lifetime of the author's poems as a movement in grammar
- [[the poems treat incompletion as a position rather than a defect]] — the counterweight from the same collection: a body of work that refuses closure on purpose, and the one poem that reverses it
