...
- Atlas §XI.1b records the tension between what it calls the escrow system (kept promises) and praxis, with the gate-practice treatment.
- Walked X describes the escrow system's operation; walked XI states the conflict.
- The space-around survey locates the historical precedent for a text built around mandatory stopping: the Spiritual Exercises — see [[ignatius of loyola]].

---

Relevant Notes:
- [[nothing transforms from the audience]] — the law that requires the pause
- [[beauty recruits the wrong posture]] — the sibling tension on the style side
