...
- The book's half is on record: the container makes an open center by holding and withdrawing (atlas §II), and the book already names *kenosis* beside *anatta* and *fana* as one territory in three vocabularies (abridged ch5-era material, recorded at [[the fullness of the first person is the road to selflessness rather than its obstacle]]).
- *Kenosis*'s half is now shown, from the hymn read whole in the KJV and ESV with the Greek of 2:7 confirmed at the interlinear (the reading record is `archive/reading — the philippians hymn on kenosis (phil 2.5-8).md`). Philippians 2:7 reads ἑαυτὸν ἐκένωσεν, "himself emptied" — "emptied himself" (ESV), "made himself of no reputation" (KJV) — and the movement runs downward by subtraction: "took upon him the form of a servant" (2:7), "he humbled himself, and became obedient unto death, even the death of the cross" (2:8). Room and love are made by pouring out rather than by adding.
- The refusal is kept, and it places *kenosis* on the fork, with one refinement the reading forces. It is Christological — *God's* act in the incarnation, "who, though he was in the form of God, did not count equality with God a thing to be grasped" (2:6) — and its dominant reading is self-renunciation and condescension, which pulls it toward Weil's decreation and the renunciation pole rather than toward the book's restored first person. The refinement: the hymn is offered as a pattern the community is to imitate — "Have this mind among yourselves, which is yours in Christ Jesus" (2:5) — so it is nearer the book's practical register than a purely cosmic event would be, but the pattern is downward, so it stays company for the container that withdraws and adversary-adjacent on the self.
