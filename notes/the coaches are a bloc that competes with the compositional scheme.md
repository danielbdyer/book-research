...
The corpus surveys eleven contemporary teachers and reports that beneath their marketing they hold exactly five theories of where suffering lives — a believed thought, a resisted feeling, a disempowered state, disowned complicity, a closed body or withheld gift ([[the transformation field divides into five theories of where suffering lives]]). It then puts them to work as a referral network: which difficulty routes to which practitioner, with the body as tiebreaker.

Read individually that is what they are. Read together they are something else. Each of the five is a complete account of where suffering lives, and the book's own account is that it lives in combination — primitives composing into compound diagnoses, the formula holding both the trouble and its remedy. Those are rival answers to one question. The five say suffering has *a* location; the compositional scheme says it has a combinatorial one. The mesh grid states the consequence: "The book has to either subsume them or beat them, and right now it does neither out loud" (`mesh grid: the coaches`).

The reframing changes what the roster's largest disagreement is about. The corpus records the five as fault lines kept honestly open, and reads the openness as a virtue — a living argument rather than a settled canon. That reading holds if the five are colleagues who disagree with each other. It does not hold if they collectively disagree with the book, because then the unresolved fork is not between them but between all of them and the scheme that claims to contain them.
...
Relevant Notes:
- [[the transformation field divides into five theories of where suffering lives]] — the survey this reframes, whose five camps are the bloc
