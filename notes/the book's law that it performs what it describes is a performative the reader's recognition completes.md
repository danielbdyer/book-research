...
"The book performs what it describes" is not a report about the book — it is itself a performative, a sentence that does the thing it names, in the family of "I promise" and "I do." And Austin's own machinery says a performative is not finished in the speaking: it requires *uptake*, the hearer's receiving, or the act "will not have been happily performed." So the book's central law hands the reader an extraordinary role: the sentence describing recognition becomes *true* only when a reader actually recognizes — the reader's answer is the felicity condition of the book's deepest claim. What the reader gains is that their recognizing is not evidence that the book worked; it is the working. Its use to the writing is to reveal the law is secretly *about the reader* — its truth-condition is the reader's recognition, so the book cannot verify itself and was never meant to.
...
Relevant Notes:
- [[the book performs what it describes]] — the law this reads as a performative whose truth the reader's uptake completes
- [[the book must respect that it cannot verify the reader has done the work]] — the consequence this draws, the book unable to verify its own success by design
- [[the apparatus descends from the settlement the book positions itself against]] — the descent-relations note whose six citation-relations this Austin/Derrida case is one instance of
