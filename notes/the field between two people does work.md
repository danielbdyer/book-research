...
The book claims that the field between two people in genuine contact is a real participant. The first-telling states the claim in those terms — "a real participant, not a figure of speech" (first-telling: the between). Chapter 8 names it the Third Entity: a third thing that neither person contains, generated by the contact itself. The claim is functional: the corpus tests it by what the field does, and the first-telling's formulation is "the field does work. It metabolizes things neither person can metabolize alone" (first-telling: the between). The first-telling locates the idea in Martin Buber's territory and states the summary bluntly: "the field does work."
