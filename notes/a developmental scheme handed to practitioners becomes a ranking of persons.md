...
- The tension carried no treatment for as long as no candidate design feature had been named — by the book, by the precedents, or by the grid. Three candidates now exist and the field still reads unassigned, because naming a candidate is not choosing one; the author resolves this, and the vault does not.
