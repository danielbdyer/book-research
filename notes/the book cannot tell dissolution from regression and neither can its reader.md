...
- Stated on the grid's authority and `nascent`: the pre/trans literature and Grof's clinical work are unread here. The reading is seventh in the ranked holes at `ops/lineage sort.md`, with the grid's note that it rises "with every peak-state passage."
