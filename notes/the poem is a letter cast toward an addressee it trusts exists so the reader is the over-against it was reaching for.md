...
- Celan: "a poem can be a message in a bottle, sent out in the — not always greatly hopeful — belief that it may somewhere and sometime wash up on land, on heartland perhaps" (Bremen Prize speech, 1958); the poem is "lonely and en route," it "intends an Other, needs this Other, needs an over-against, and seeks it out, speaks toward it" (The Meridian, 1960). The book's own record arrives independently: the poems are the primary layer the corpus quotes, and the confirmed sighting of recognition happened while reading a letter.
- Refusal kept, central to Celan: the hope is "not always greatly hopeful," the bottle may never wash up, the poem risks going unanswered — keep the "perhaps," never a guarantee that the reader was always coming.
- Standing: a reach; verify the Bremen and Meridian wording, and read the poems themselves for an interior "you" (which would move this from analogy to evidence); filed with Celan's "perhaps" intact.
