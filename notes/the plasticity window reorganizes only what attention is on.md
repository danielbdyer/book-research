---
description: Psychedelics reopen a period of enhanced plasticity lasting days to weeks, and the reorganization is context-dependent, which supplies a second and different mechanism for why a breakthrough does not hold.
category: claim
...
The synthesis received 2026-08-05 reports a 2023 finding that psychedelics reopen critical periods — windows of enhanced plasticity that normally close after early development — with durations proportional to the subjective effects: roughly 48 hours for ketamine, two weeks for psilocybin and MDMA, three for LSD, four or longer for ibogaine. The mechanism is described as a plasticity of plasticity: an enhancement of the brain's general capacity to reorganize rather than a change in any particular circuit.

The load-bearing part is the qualification, quoted in the synthesis from the researcher: "The fact that the drugs are context-dependent means that you're only going to reorganize the subset of circuits and synapses that are relevant to that particular context." The window opens; what gets rebuilt is whatever the person is attending to and doing while it is open.

That is a mechanism for the book's central question — why the breakthrough did not hold — and it is **not the mechanism the vault already had**. The state-and-structure account says the experience was received and interpreted by an apparatus it did not change ([[an enormous experience is interpreted by the structure it did not change]]). This says something different: the apparatus *was* changeable, for a specific and short period, and nothing was done in it. "A person can have a profound experience of interconnection, return to the same job, relationships, and habits, and find that nothing changed. The insight was real, but the window for embodying it closed without new patterns being established."
...
Relevant Notes:
- [[an enormous experience is interpreted by the structure it did not change]] — the other mechanism for the same question, held beside this one rather than merged with it
