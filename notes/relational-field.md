...
- [[each duetting wren's brain carries the whole song rather than its own half]] — an electrophysiology witness accompanying the field claim: each brain carries the joint song rather than its own half
...
- [[the relational field supplies the correction that solitary introspection lacks]] — where the correction the solitary reader lacks actually lives, in the field the reader participates in, running with [[both attacks on the standard blame the absence of correction by another person]] and [[the second chair is the verification standard's own requirement]] while leaving the one-chair wound intact.
...
- [[status is a physics of observable transactions rather than an inner attribute]] — Johnstone's status as an operable transaction read off the body, which gives the field a teachable mechanism the book's relational claim otherwise asserts without one.
...
- [[the effort to be original is itself what blocks spontaneity]] — the field's spontaneity freed by dropping the demand to be interesting, a facilitation move that removes the block structurally rather than by exhortation.
...
- [[side-coaching cannot cross to a book because the page cannot speak during play]] — the sharpest crossing failure, since side-coaching is live timed intervention and a page cannot speak during the play it would correct.
- [[the improv lineage's devices assume co-presence so most fail on a book read alone]] — the crossing verdict for the whole lineage, that its devices assume a room and a live other, so only a thin remainder reaches a solitary reader.
...
- [[the facilitated room's documented origin set its standard as social adaptability rather than felt transformation]] — the caution the craft carries, since the room's documented origin measured social adaptability, not the felt transformation the book's field aims at.
- [[the improv method franchised into a product reinstalls the approval it was built to remove]] — the field's failure mode when commodified, spontaneity becoming a product and approval re-entering as the laugh.
- [[status physics stripped of its liberatory frame becomes a manual for domination]] — the field's craft turned against itself, Johnstone's status work becoming a manipulation manual once its liberatory frame is removed.
- [[the play lineage verifies its felt shift by co-present witness a solitary reader cannot furnish]] — the lineage's whole verification, co-present observable behaviour plus shared flow, which is the second check this map's solitary reader cannot furnish.
- [[a procedure that manufactures presence has already converted the thou into an it]] — Buber's blade against the whole craft and the book, since I-Thou is untransferable into method, so any procedure that manufactures presence has already made the other an It.

### The developmental and communal ground of the field (Dig 7)

- [[the good-enough other's graduated failure to adapt is the developmental engine]] — Winnicott's engine of relationship, an other who adapts almost wholly then fails in tune with growth, which is the field's developmental form and what a book can only approximate.
- [[the potential space where play and culture live sits between the person and the environment rather than inside either]] — Winnicott's third area, neither inner fantasy nor external fact, which is this map's between named in developmental terms and shown to depend on a reliable other.
- [[a book cannot supply the basic trust a reader who never had a reliable other lacks]] — the field's hardest limit, since where basic trust was never built a book has no purchase and cannot supply the non-impinging other retroactively.
...
- [[structure is the container that outlasts a community's decay rather than the cause of it]] — the same law stated as the container doctrine, that spontaneous fellow-feeling's passage into rule is exceptionless, so structure outlasts the field's decay rather than causing it.
- [[the threshold state strips status and leaves a person betwixt and between]] — Turner's liminality as the field's transitional condition, statusless and betwixt-and-between, the state a held container carries a person through.
...
- [[every historical margin architecture ran inside a binding community and none is portable to a solitary reader]] — the finding that bounds every margin device for this map, since each ran inside a binding community and subtracting it removes what made it work.
- [[subtracting the community from the talmud page converts it from staging disagreement to looking one up]] — the mechanism of that loss, since folding the apparatus into one navigable answer removes the partner and the held disagreement, so a dispute becomes a lookup.
...
- [[the felt sense of connection is produced by coordination whether or not anything durable changed]] — the field's own counterfeit, since coordination generates a felt sense of connection on its own, so a feeling that the field is deepening can be an artifact.
- [[the criterion for when an interaction gains autonomy is contested as too broad and arbitrary]] — the live dispute over the field's mechanism, since participatory sense-making's test for an autonomous interaction is charged with being too broad, which bounds how much the mechanism can carry.
- [[an interaction science term earns its place by its worked mechanism rather than its aura]] — the admission bar for the field's borrowed vocabulary, so structural coupling earns its place by a worked causal chain rather than by sounding significant.
- [[the imperative to increase the number of choices is too empty to guide a facilitation decision]] — von Foerster's facilitation ethic read as insufficient, since widening options cannot rank them and a tyrant maximizing his own options satisfies it.
...
- [[even the sociology of resonance concedes that a felt encounter needs a second person to certify it]] — Rosa's resonance reaching the second chair, since felt quality cannot sort genuine from ideological and his own remedy needs a third-person observer.
- [[the felt shift's external check can be a resisting world, not only another person]] — Crawford's craft push-back as a second, non-personal form of the field's missing external check, one a book as a weak jig can barely furnish.
- [[the compliance attack taken to full strength demands the second-person check rather than dissolving it]] — the adversary chamber ratifying the field, since demand-made effects vanish once demand is removed and the blind-assessor test needs someone the reader cannot be.
