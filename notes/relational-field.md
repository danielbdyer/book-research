...
The space-around survey named five additions for this map. On 2026-08-07 the author asked for a pruning of the candidate shelf, and four of the five were declined there, each with its reason recorded in `ops/queue/declines.md`. Tronick's still-face experiment lost its place because a larger measured warrant for the same relational claim now sits in the vault: the alliance meta-analysis of Flückiger, Del Re, Wampold and Horvath, which was read whole across 295 studies and more than thirty thousand patients ([[the participation law has measured support at a scale nothing else in the book approaches]]). Levinas's asymmetry lost its place because the counterweight this material actually needs is already queued and measured, namely the demand-withdraw literature of Christensen and Heavey with the Schrodt meta-analysis, which documents pursuit itself working as a mechanism of withdrawal. Merleau-Ponty's intercorporeality lost its place because the same lineage already holds an evaluation at [[de jaegher and di paolo]], whose participatory sense-making states the mechanism in operational terms. Collins's interaction ritual chains lost its place because no live question in the vault turns on the sociology of why a practice must recur. The fifth proposal stands: the warning that witnessing can shade into consumption is this map's nearest counterweight, since [[a witness kept as proof forecloses what it proves]] already states its shadow from the author's own record. The Ubuntu tradition left the list earlier and for the opposite reason, since its evaluation stands at [[ubuntu personhood]] in this map's mechanism section, with the primary reading undone. The consumption warning is this map's nearest counterweight, since [[a witness kept as proof forecloses what it proves]] already states its shadow from the author's own record.
