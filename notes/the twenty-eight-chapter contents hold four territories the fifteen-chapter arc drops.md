...
The first is the design of time. The earlier scheme gives a whole part — its fourth, four chapters — to temporal coherence, nervous-system-aligned scheduling, micro-rituals, and what it calls sovereignty anchors. The later arc treats time as the metabolic arc's pacing and as the temporal loop's regulation, and never as something a reader designs a day around. The second is the externalized system: soul-aligned second brains, symbolic infrastructures, and ritual templates for seasons and bookends. The later arc's practice curriculum is entirely interior and dyadic; nothing in it is built outside the body. The third is aesthetic practice, treated in the earlier scheme as a chapter of its own and present in the later arc only as the risk that beautiful prose recruits the wrong posture. The fourth is the deliberate arc of partnership — conscious coupling and decoupling — where the later arc treats the relational field as a standing condition rather than as something entered and left on purpose.

What the divergence establishes is that the later arc's compression was a set of choices, each of which dropped something. The vault records the four territories so that the choices remain visible and reversible; whether any of them should return is the author's question, and nothing in the sources answers it.
