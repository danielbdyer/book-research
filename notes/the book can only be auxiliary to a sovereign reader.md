...
- **The book's own foundations sign one half of this claim and dispute the other, and saying which is which is the honest form of the support (recorded 2026-08-08).** The claim has two halves: the book cannot cause the change, and whatever changes, the reader did it. The first half — the humility clause — is underwritten by both foundations, because each refuses the manufactured breakthrough in its own vocabulary ([[both poles of the convergence refuse the engineered epiphany]]). The second half — the attribution clause — is disputed by one of them. The Kashmir Śaiva refusals derived from the tradition's own texts include the sovereign reader as final cause, on the ground that grace descends independent of what the recipient did to earn it, so the reader's participation is not the last word about what happened ([[the kashmir shaiva tradition would decline four of the book's deepest moves]]). The book may therefore cite its foundations for the limit on its own power and may not cite them for the credit it assigns the reader, and the crossing between these two areas of the graph is the sparsest one the clustering found, which is why the split went unstated until now.
