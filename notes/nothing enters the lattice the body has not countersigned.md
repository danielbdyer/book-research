...
- [[the verification standard rests on one name and that name has no chair]] — the structural fact about this rule: one bearer, so no convergence defends it
