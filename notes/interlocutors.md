...
- [[david loy]] — seated, reference-lineage. His account of constitutive lack independently confirms the book's first contraction.
- [[gregory bateson]] — candidate. The survey flags him as "possibly the largest single missing grandfather in the whole edifice" (space-around: around the engine).
...
Roughly sixty candidates are enumerated in `ops/queue/candidates.md`; the five listed above are the survey's own priority order. The roster above names about a hundred seated thinkers and works; they get notes when a claim needs them, because creating them all at once would add volume without use.
