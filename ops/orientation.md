...
The book's centerpieces, by author decision, are the convergence of thinkers — independent arrivals at the same finding, quoted with their refusals intact — and the lived practice, verified in the body (`ops/methodology/center of gravity.md`). The core thesis the author names in his own words: these thinkers illuminate an underdeveloped aspect of human reality — deep change as disclosure of the already-present rather than acquisition or repair.

The research is about the primary material, not the seven documents in `sources/`: "this research is and has always been about the primary material… not the sources I've provided" (`ops/methodology/the primary material.md`). A thinker's own work is primary; the corpus's account of that thinker is not; where the two conflict the primary material governs and the conflict is recorded. Beneath the corpus sit the layers it quotes — the author's poems and the provenance record — where he said the plain things first and the scholarship arrived afterward and dressed them.

The book verifies in the body rather than in the argument, which makes the felt shift its whole verification standard, and the author judges that standard underdefended. The schemes — the triad, the primitives, the molecules, the loops — are demoted from architecture to instrument, so gaps and overlaps in the scheme set are never work. The vault is measured by what reaches the manuscript.
