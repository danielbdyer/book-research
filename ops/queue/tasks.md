...
The working queue the /tasks, /next, and /ralph commands read. Entries reference the two standing lists: `candidates.md` (pending thinker and concept evaluations) and `extractions.md` (pending source regions). Sessions add and complete entries here; completed batches move to `archive/` inside this folder.
