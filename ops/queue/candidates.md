...
**2026-08-16, reconciling the record.** The `*2026-08-07 pass:*` notes below argued each of these lineage-list names toward a decline, and the author reversed that cut in full the same day, so every name here stands as a live candidate rather than a declined one; the reversal is recorded in `ops/queue/declines.md`, Reversals. The entry in `ops/queue/extractions.md` that had recorded these names as declined was reconciled to match on 2026-08-16.
...
## The transmission expedition, 2026-08-13/14

The seven transmission digs (`provenance/transmission digs/`, under the commission at `provenance/transmission digs/commission — the transmission digs.md`) surfaced the figures below and returned a seat verdict for each, in the commission's own verdict vocabulary — *load-bearing*, *ground for running machinery*, *stress-test*, *precedent-bench*, *directional*, *decline*. Rendered here as candidate evaluations: a recommendation, a one-sentence justification, and the dig it came from. **They decide nothing and are not seatings** — the seating is the author's. The verdicts rest on mostly secondary-depth reads (each dig's primary reads are queued in `ops/reading queue.md`, Tier 7), so they are lighter than an `[e]` primary evaluation and are not marked `[e]`. Where the vault already holds an interlocutor note of the figure's name, the dig's finding is recorded as a one-line update pointing to that note rather than a duplicate entry; those come first. The interlocutor notes themselves are not edited from here — this file only records the verdict against them.

Folded 2026-08-16 (Phase 4, a–k half): the dig verdicts for the seven figures in this half already holding interlocutor notes — Gregory Bateson (Dig IV), De Jaegher and Di Paolo (Dig IV), Heinz von Foerster (Dig IV), Hartmut Rosa (Dig V), Keith Johnstone (Dig VII), Donald Winnicott (Dig VII), and J. L. Moreno (Dig VII) — are now recorded as one dated sentence in each note's evaluation section; Bateson and Rosa were also seated reference-lineage under B5/E, while the other five remain candidate.

_The mesh verdicts for the l–z figures — Kierkegaard, Wittgenstein, Iser, Maturana and Varela, Polanyi, Adorno, Orne, Britton, Spolin, Turner, and Buber — were folded into their interlocutor notes as dated lines on 2026-08-16 (Phase 4, l–z half); each note's functional seat stays `candidate` because the verdict recommends a load, already set, rather than a functional seat._

### Updates to figures that already hold interlocutor notes (dig verdict; no new entry)

- Søren Kierkegaard — `notes/soren kierkegaard.md`. **Dig I: load-bearing, with a stress-test flag** — he built the named device-inventory for the trust-and-disappear problem and located its breaking points himself, but the deception and asymmetry are a stress-test the book must survive, not a technique to adopt. (Also shelved above under "Around the honesty" and as an address-opponent; this adds Dig I's transmission finding and queues four primary reads at Tier 7, entries 55–58.)
- Ludwig Wittgenstein — `notes/ludwig wittgenstein.md`. **Dig I: directional** — the ladder (the self-disposing book) and the therapy-turn (philosophy as treatment, not doctrine) are two portable devices that point a direction for the medium without supplying content. (Reading queued at Tier 7, entry 60.)
- Wolfgang Iser — `notes/wolfgang iser.md`. **Dig II: load-bearing** — the participation-gap is the strata's most exact mechanism for enactment over appreciation, and "we do not know what happens to us" is the honest boundary the felt-shift claim must answer. (Reading queued at Tier 7, entry 62.)
- Gregory Bateson — `notes/gregory bateson.md`. **Dig IV: load-bearing** — he supplies the distinct-level logic and the soberest boundary-marker, that the felt shift cannot self-certify at the depth of self-dissolution. (Reading queued at Tier 7, entry 73.)
- Maturana and Varela — `notes/maturana and varela.md`. **Dig IV: ground for running machinery** — the citable biology under "perturb not install" and "meaning made in interaction," to be run with its contested tag and self-undermining edge visible. (Reading queued at Tier 7, entry 71.)
- De Jaegher and Di Paolo — `notes/de jaegher and di paolo.md`. **Dig IV: load-bearing** — the only program that operationalizes rupture-and-repair and meaning-in-interaction with an evidence base. (Reading queued at Tier 7, entry 74.)
- Michael Polanyi — `notes/michael polanyi.md`. **Dig IV: stress-test** — the from-to structure of tacit knowing threatens the book's own central instruction to attend to the felt shift. (Reading queued at Tier 7, entry 72.)
- Heinz von Foerster — `notes/heinz von foerster.md`. **Dig IV: directional** — a candidate ethic ("increase the number of choices") that points a way but is too formally empty to bear weight. (Reading queued at Tier 7, entry 75.)
- Hartmut Rosa — `notes/hartmut rosa.md`. **Dig V: load-bearing** — the strongest civilizational-scale scaffolding under the why-now and the sociological ground for the felt-shift's refusal of the instrumental reader, bolted to its own fascism/normativity fault. (Already evaluated `[e]` 2026-08-02 under "Priority"; this adds Dig V's finding and queues two reads at Tier 7, entries 76–77.)
- Theodor Adorno — `notes/theodor adorno.md`. **Dig VI: stress-test** — the most dangerous internal auditor; seat him permanently so the register survives his charge sentence by sentence. (Reading queued at Tier 7, entry 50.)
- Martin Orne — `notes/martin orne.md`. **Dig VI: stress-test** — the methodological bar any felt-shift claim clears before it counts as evidence. (Reading queued at Tier 7, entry 49.)
- Willoughby Britton — `notes/willoughby britton.md`. **Dig VI: ground for running machinery** — the one contemplative program with a working anti-compliance instrument (low-demand harm assessment). (Reading queued at Tier 7, entry 52.)
- Viola Spolin — `notes/viola spolin.md`. **Dig VII: ground for running machinery** — she supplies the craft the facilitated room runs on (point of concentration, side-coaching, approval-removal); machinery, not thesis. (Reading queued at Tier 7, entry 81.)
- Keith Johnstone — `notes/keith johnstone.md`. **Dig VII: load-bearing** — status plus teacher-takes-failure is a specifiable working solution to trust-and-disappear and to appreciation-versus-enactment. (Already evaluated `[e]` 2026-08-05 from the mesh grid; this adds Dig VII's finding in his own first discipline and queues a read at Tier 7, entry 82.)
- Donald Winnicott — `notes/donald winnicott.md`. **Dig VII: load-bearing** — potential space plus the capacity to be alone is the one developmental theory making solitary transformation coherent and naming its precondition. (Reading queued at Tier 7, entry 83, distinct from the tier-6 object-usage read.)
- Victor Turner — `notes/victor turner.md`. **Dig VII: directional** — the communitas-decay typology is an early-warning system for any community the book gathers. (Reading queued at Tier 7, entry 84.)
- Martin Buber — `notes/martin buber.md`. **Dig VII: stress-test, seat conditional on the wider roster** — the test every device must pass, "does it turn Thou to It?" (Already evaluated `[e]` 2026-08-05 from the mesh grid; this adds Dig VII's device-test finding and queues a read at Tier 7, entry 86.)
- J. L. Moreno — `notes/j l moreno.md`. **Dig VII, the absent stratum** — the play-lineage roster reached its subject without him, though he is arguably the closest direct ancestor of the facilitated room and coiner of "warm-up," "spontaneity training," and sociometry; the note should record that the dig found the lineage incomplete at its head, and a scoping read is queued at Tier 7, entry 87.

### New candidate figures the digs surfaced (dig verdict; awaiting the author and a primary reading)

*From Dig I — indirect communication:*
- [ ] Plato, the *Seventh Letter* — **Dig I: precedent-bench.** The classical statement that the deepest thing cannot be written, delivered by a man who wrote thirty books anyway, is the standing precedent for a book that aims at ignition while conceding it cannot guarantee it — cited for the precedent, not seated as doctrine. Distinct from the Plato's-anamnesis entry under "The crossover's field" above, which is ancestry recorded as a claim; this is the *Seventh Letter*'s unwritten-teaching position, which Dig I opened directly ([P] at classics.mit.edu), authenticity disputed and immaterial to the use. The queued Plato reading (Tier 7, entry 59) is the *Theaetetus*/*Meno* maieutic half.

*From Dig II — the reader's half of the transaction:*
- [ ] Louise Rosenblatt — **Dig II: stress-test.** Her efferent/aesthetic binary locates the missing third stance by what it cannot hold — a reading whose product is altered capacity — and her aesthetic-equals-connoisseur equation is a warning, not a support. (Reading queued at Tier 7, entry 61; the dig's findings are already lodged as claims in `notes/`.)
- [ ] Roland Barthes — **Dig II: stress-test / precedent-bench.** The writerly-impossibility report is load-bearing against any writerly-at-scale ambition; jouissance is a felt-shift precedent that also exposes it to the aura charge. (Readings queued at Tier 7, entries 63–64.)
- [ ] Hans-Georg Gadamer — **Dig II: ground for running machinery.** Play and the fusion of horizons give the participation-model its ontology, the event owned by neither reader nor text; the concession to Habermas is the built-in warning about laundered authority. (Reading queued at Tier 7, entry 65.)
- [ ] Stanley Fish — **Dig II: decline.** He converts participation into compliance — the interpretive community determines the reading — and is kept only as the reductio the book refuses. No reading queued; the decline is the finding.

*From Dig III — margin architectures:*
- [ ] The Talmud page (the Rashi/Tosafot layout) — **Dig III: precedent-bench.** The clearest working instance of an explainer-plus-challenger margin run unresolved for five centuries; a structure, not a person. (Reading queued at Tier 7, entry 70, on whether the layout was designed or retrofitted.)
- [ ] Chavruta (the study pair) — **Dig III: stress-test.** It threatens the book's premise by naming what the solitary reader structurally lacks — the page may not transmit without a second reader. (Reading queued at Tier 7, entry 69, Kent and Holzer.)
- [ ] The *Blue Cliff Record* (as margin architecture) — **Dig III: precedent-bench.** The maximal five-voice margin machine, available as precedent and as cautionary limit. (Its burning by Dahui is queued as a historicity question, Tier 7, entry 68.)
- [ ] Dahui Zonggao — **Dig III: stress-test.** His burning of the *Blue Cliff Record* is the connoisseur attack from inside a contemplative tradition; his huatou is the directional anti-margin answer. (Reading queued at Tier 7, entry 68, the burning's historicity.)
- [ ] Ivan Illich, with Hugh of St. Victor — **Dig III: ground for running machinery.** The causal inventory of the last time page technology rewired reading, the history under any why-now claim about media. (Reading queued at Tier 7, entry 66.)
- [ ] Guigo II, with lectio divina — **Dig III: precedent-bench.** A verified four-rung reading protocol whose verification, contemplatio, refuses to be commanded. (Reading queued at Tier 7, entry 67.)
- [ ] The Glossa ordinaria — **Dig III: decline.** Standard-issue medieval margin technology, less on-point than the Talmud for a two-voice book. No reading queued.

*From Dig V — the why-now sociology:*
- [ ] Albert Borgmann — **Dig V: ground for running machinery.** The device paradigm supplies the mechanism and the focal-practice criteria the working test (practice over episode); his subjective-state warning, that treating a focal event as a state makes it commodifiable, is the sharpest internal stress-test of the book's standard. (Reading queued at Tier 7, entry 79.)
- [ ] Byung-Chul Han — **Dig V: directional.** A precise portrait of the reader's condition that points the direction but structurally cannot supply a remedy; carry the diagnosis, not a program. Already shelved above (under "Around the word psychedelic" and "Around the promise") and queued as a Han evaluation in `ops/reading queue.md`; this records Dig V's verdict and its read (Tier 7, entry 78) rather than a fresh duplicate.
- [ ] Matthew Crawford — **Dig V: precedent-bench.** A worked case that craft-submission builds a self, with an external verification standard — reality certifies, not the room — worth borrowing. (Reading queued at Tier 7, entry 80.)
- [ ] Jenny Odell — **Dig V: precedent-bench.** The argument's popular-register restatement; evidence of reach, flagged for its privilege assumption. No reading queued (Dig V reached her via reviews).

*From Dig VI — the adversary chamber:*
- [ ] Irving Kirsch — **Dig VI: stress-test, load-bearing for the attack.** The strongest single mechanism turning "felt shift" into "manufactured experience" — response expectancy that confirms itself whether or not work was done. (Reading queued at Tier 7, entry 51.)
- [ ] Morton Lieberman, with Irvin Yalom — **Dig VI: precedent-bench.** The casualty base rate for what high-demand transformational rooms cost, from the encounter-group casualty study (Lieberman, Yalom and Miles, 1971/73); the durable-outcomes review is queued at Tier 7, entry 53. This is Morton A. Lieberman (encounter-group casualties), not Matthew Lieberman (affect labeling), who is shelved above under "Around the practice" — the surname collision is worth flagging.
