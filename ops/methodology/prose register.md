...
13. **No mannered prose.** Added 2026-09-25, in the text the author gave as the directive: "Mannered prose substitutes metaphor and flourish for direct statement. Instead of 'a parameter worth varying,' the mannered writer produces 'a dial worth turning.' Instead of 'this point still matters,' they write 'this point earns its keep.' The phrases exist to display the writer, not to convey the idea, and readers can tell. That is why mannered prose irritates: it makes the reader work harder so the writer can perform. It is also imprecise. Metaphors drag in connotations the writer did not choose and cannot control. The fix is to say what you mean. When a literal phrase is available, use it." The occasion was the author's flag of a whole pull request (#23, the reframe map, the system designed from it, and the documents reading the vault against that system) on the same day: "I'm afraid I don't understand much of this writing… It needs to be plain language across the board… We cannot regress." Rule 9 already keeps figures of speech inside quotation marks; this rule applies the same test to single words and short phrases, so a word used figuratively gives way to the literal word wherever one exists.
