...
A locus is a bounded place to see from. Standing in one, some things become visible and others fall dark — and that is not a defect but the condition of seeing anything at all. In the book's own Kashmir-Śaiva vocabulary, a locus is a *saṅkoca*: a contraction of awareness into a particular standpoint. Reflexive awareness of the standpoint one is in — noticing *"this is where I'm seeing from, and here is what it hides"* — is *vimarśa*. So the book's method (read from many standpoints, let none rule) and its metaphysics (awareness contracts into loci and can recognize itself doing so) are one movement. That is why the Loci is the first family: it is the layer at which "a lens" stops being a metaphor and becomes the thing the book is actually about.
...
- **Open edge:** in the vault this seat is *currently unpopulated* — the function is scattered across reference-lineage and coaches with no clean seated set; and its ancestors (Spolin, Moreno's psychodrama) are named-but-unseated. This is the widest open edge in the register relative to the locus's importance.
