...
- **Within the founding convergence, his felt weight is on the pratyabhijñā pole.** He did not choose "things un-concealing" (Heidegger's *aletheia*) for the no-seam, nor "felt in the body" (Merleau-Ponty's flesh). So of the two poles the book rests on ([[aletheia and pratyabhijna converge on truth as un-forgetting]]), his heart sounds the recognition-school side more than the un-concealment side — an inference from what he passed over, and his to confirm or correct. The resonance is felt kinship, not doctrinal assent: the tradition would still decline four of the book's deepest moves ([[the kashmir shaiva tradition would decline four of the book's deepest moves]]).
