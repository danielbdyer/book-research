...
|------|----------|----------|
| `provenance of the corpus.pdf` | `provenance reconstruction` | Round one: the seven questions of the source-conditions request, answered; flagged overstatements; gaps ledger. |
