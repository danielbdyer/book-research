...
Six standing directives govern all prose and naming. Each is recorded in full in `ops/methodology/`; the whole directive set is indexed at `ops/methodology/methodology.md`.
