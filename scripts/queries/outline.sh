...
#
# Usage: scripts/queries/outline.sh          rewrite ops/outline.md, print a summary
#        scripts/queries/outline.sh --print  print the census to stdout, write nothing
# Run from anywhere.
cd "$(dirname "$0")/../.." || exit 1
...
OUT = pathlib.Path("ops/outline.md")
BEGIN = "<!-- BEGIN CENSUS — regenerated by scripts/queries/outline.sh; edits here are overwritten -->"
END = "<!-- END CENSUS -->"
